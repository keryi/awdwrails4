class LineItemsController < ApplicationController
  ...
  before_action :reset_view_count, only: [:create]
    ...
    respond_to do |format|
      if @line_item.save
        format.html { redirect_to store_url,
          notice: 'Line item was successfully added.' }
  ...
  def decrement
    ...
    respond_to do |format|
      format.js
      format.html { redirect_to store_url, notice: "Reduce 1 #{@line_item.product.title} from your cart." }
    end
  end
